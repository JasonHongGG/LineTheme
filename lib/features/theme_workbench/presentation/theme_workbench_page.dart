        ...
        children: <Widget>[
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: controller.urlController.text.isEmpty ? null : IconButton(tooltip: '清除網址', onPressed: state.applyingTheme ? null : controller.clearUrl, icon: const Icon(Icons.close_rounded)),
            ),
          ),
          const SizedBox(height: 14),
          SizedBox(
