...
class LineThemeTesterApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final baseTextTheme = GoogleFonts.notoSansTcTextTheme().apply(
      bodyColor: const Color(0xFF201E1C),
      displayColor: const Color(0xFF201E1C),
    );
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: const ColorScheme.light(
          primary: Color(0xFF22252B),
          secondary: Color(0xFFC88D5B),
          tertiary: Color(0xFF6F7C8D),
          surface: Color(0xFFFFFCF7),
          surfaceContainerHighest: Color(0xFFE9E1D5),
          onSurface: Color(0xFF201E1C),
          error: Color(0xFFB4503C),
        ),
